            ...
            <footer>
                <div id="socials" className="flex flex-col w-full h-full justify-center pl-20">
                    ...
                    <div className="flex flex-row items-center">
                        <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/nehs.robotics?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><img className="w-6 h-auto" src="/assets/instagram.svg" alt="Instagram logo."/></a>
                        <a target="_blank" rel="noopener noreferrer" href="https://www.tiktok.com/@nehs.vikings.10143?is_from_webapp=1&sender_device=pc"><img className="w-8 h-auto" src="/assets/tiktok.svg" alt="Tiktok logo."/></a>
                    </div>
                </div>
